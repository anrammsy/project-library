...
const italyBtn = document.getElementById("it");
const usaBtn = document.getElementById("us");
const chinaBtn = document.getElementById("cn");
const plusTimeBtn = document.getElementById("plusTime");
const minusTimeBtn = document.getElementById("minusTime");
...
italyBtn.addEventListener("click", () => {
  const itRecipes = recipes.filter((recipe) =>
...
usaBtn.addEventListener("click", () => {
  const usRecipes = recipes.filter((recipe) =>
...
chinaBtn.addEventListener("click", () => {
  const cnRecipes = recipes.filter((recipe) =>
    recipe.cuisineType.includes("chinese")
  );
  recipeBox(cnRecipes);
});

function sortByTimeMinus() {
  const sortRecipes = [...recipes].sort(
    (a, b) => (b.totalTime || Infinity) - (a.totalTime || Infinity)
  );
  recipeBox(sortRecipes);
}
function sortByTimePlus() {
  const sortRecipes = [...recipes].sort(
    (a, b) => (a.totalTime || Infinity) - (b.totalTime || Infinity)
  );
  recipeBox(sortRecipes);
}

minusTimeBtn.addEventListener("click", sortByTimeMinus);
plusTimeBtn.addEventListener("click", sortByTimePlus);
